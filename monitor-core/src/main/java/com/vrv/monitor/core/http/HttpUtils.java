...
public class HttpUtils {
	...
	public static String post(String url, final HttpEntity httpEntity, ContentType contentType,
		...
		//这里可以加 auth basic 验证
//		httpPost.setHeader("Authorization", "Basic " +Base64.getEncoder().encodeToString("OA_USER:handhand0".getBytes()));
	 ...
	 * 简单ssl 处理， 不作任何验证处理
	 */
	private static class SimpleTrustManager implements X509TrustManager, X509HostnameVerifier {
